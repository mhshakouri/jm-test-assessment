...
const buttonClasses = computed(() =>
  "flex cursor-pointer items-center gap-2 rounded-md bg-jm-white text-jm-blue-darker dark:bg-jm-blue-lighter dark:text-jm-gray-lighter py-3 px-2 focus:outline-none focus:ring-2 focus:ring-jm-blue-lighter dark:focus:ring-jm-gray-lighter hover:bg-jm-gray-lighter dark:hover:bg-jm-blue-darker transition-colors duration-200"
);

const modeText = computed(() => theme.value === "light" ? "Dark" : "Light");
</script>
